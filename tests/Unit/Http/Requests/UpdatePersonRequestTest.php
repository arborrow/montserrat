 ...
 */
final class UpdatePersonRequestTest extends TestCase
{
    ...
    {   // TODO: languages and referrals
        ...
        if (config('settings.twilio_sid') !== null && config('settings.twilio_token') !== null) {
            ...
            $this->assertEquals([
                ...
                'emergency_contact_phone_alternate' => 'string|nullable',
                'emergency_contact_relationship' => 'string|max:100|nullable',
                'ethnicity_id' => 'integer|min:0|nullable',
                'first_name' => 'required|string|max:75',
                'gender_id' => 'integer|min:0|nullable',
                ...
                'occupation_id' => 'integer|min:0|nullable',
                'parish_id' => 'integer|min:0|nullable',
                'phone_home_phone' => 'string|nullable',
                'phone_home_mobile' => 'string|nullable',
                'phone_home_fax' => 'string|nullable',
                'phone_work_phone' => 'string|nullable',
                'phone_work_mobile' => 'string|nullable',
                'phone_work_fax' => 'string|nullable',
                'phone_other_phone' => 'string|nullable',
                'phone_other_mobile' => 'string|nullable',
                'phone_other_fax' => 'string|nullable',
                'prefix_id' => 'integer|min:0|nullable',
                'preferred_language_id' => 'integer|min:0|nullable',
                'primary_address_location_id' => 'integer|min:0|nullable',
                'primary_email_location_id' => 'integer|min:0|nullable',
