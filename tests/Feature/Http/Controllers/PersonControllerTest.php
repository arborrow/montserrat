...
$response->assertRedirect('PersonController@index');
...
$response->assertRedirect('PersonController@show'
$person->id);
...
$response->assertRedirect('PersonController@duplicates');
...
$response->assertRedirect('PersonController@merge'
$return_id);
