    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-6 text-right">
                @can('update-donation')
                    <a href="{{ action([\App\Http\Controllers\DonationController::class, 'edit'], $donation->donation_id) }}" class="m-1 btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                @endCan
            </div>
