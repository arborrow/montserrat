            ...
            @can('create-donation')
                <span class="create">
                    <a href={{ route('donation.create') }}>
                        {{ html()->img('images/create.png', 'Add Donation')->attribute('title', "Add Donation")->class('btn btn-light') }}</a>
                </span>
            @endCan
            <a href={{ action([\App\Http\Controllers\DonationController::class, 'search']) }}>
                {{ html()->img('images/search.png', 'Search donations')->attribute('title', "Search donations")->class('btn btn-link') }}
            </a>
