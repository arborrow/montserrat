            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h1>
                        ...
                        @can('create-donation')
                            <span class="create">
                                <a href={{ action('DonationController@create') }}>{!! Html::image('images/create.png', 'Add Donation',array('title'=>"Add Donation",'class' => 'btn btn-primary')) !!}</a>
                            </span>
                        @endCan
                    </h1>
                ...
                @else
                <table class="table table-bordered table-striped table-hover table-responsive"><caption><h2>Donations</h2></caption>
                    <thead>
                        <tr>
                            <th>Date</th>
                            <th>Donor</th>
