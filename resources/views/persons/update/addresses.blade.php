    ...
    <div class="tab-content">
        ...
        <div id="address_work" class="tab-pane fade" role="tabpanel">
            ...
            <div class="row">
                <div class="col-12 col-md-8">
                    {!! Form::label("address_home_address1", "Address Line 1:") !!}
                    {!! Form::text("address_home_address1", $defaults['Work']['street_address'], ["class" => "form-control"]) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-8">
                    {!! Form::label("address_home_address2", "Address Line 2:") !!}
                    {!! Form::text("address_home_address2", $defaults['Work']['supplemental_address_1'], ["class" => "form-control"]) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-4">
                    {!! Form::label("address_home_city", "City:") !!}
                    {!! Form::text("address_home_city", $defaults['Work']['city'], ["class" => "form-control"]) !!}
                </div>
                <div class="col-12 col-md-4">
                    {!! Form::label("address_home_state", "State:") !!}
                    {!! Form::select("address_home_state", $states, $defaults['Work']['state_province_id'], ["class" => "form-control"]) !!}
                </div>
                <div class="col-12 col-md-4">
                    {!! Form::label("address_home_zip", "Zip:") !!}
                    {!! Form::text("address_home_zip", $defaults['Work']['postal_code'], ["class" => "form-control"]) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-4">
                    {!! Form::label("address_home_country", "Country:") !!}
                    {!! Form::select("address_home_country", $countries, $defaults['Work']['country_id'], ["class" => "form-control"]) !!}
                </div>
            </div>
        </div>
        <div id="address_other" class="tab-pane fade" role="tabpanel">
            ...
            <div class="row">
                <div class="col-12 col-md-8">
                    {!! Form::label("address_home_address1", "Address Line 1:") !!}
                    {!! Form::text("address_home_address1", $defaults['Other']['street_address'], ["class" => "form-control"]) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-8">
                    {!! Form::label("address_home_address2", "Address Line 2:") !!}
                    {!! Form::text("address_home_address2", $defaults['Other']['supplemental_address_1'], ["class" => "form-control"]) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-4">
                    {!! Form::label("address_home_city", "City:") !!}
                    {!! Form::text("address_home_city", $defaults['Other']['city'], ["class" => "form-control"]) !!}
                </div>
                <div class="col-12 col-md-4">
                    {!! Form::label("address_home_state", "State:") !!}
                    {!! Form::select("address_home_state", $states, $defaults['Other']['state_province_id'], ["class" => "form-control"]) !!}
                </div>
                <div class="col-12 col-md-4">
                    {!! Form::label("address_home_zip", "Zip:") !!}
                    {!! Form::text("address_home_zip", $defaults['Other']['postal_code'], ["class" => "form-control"]) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-4">
                    {!! Form::label("address_home_country", "Country:") !!}
                    {!! Form::select("address_home_country", $countries, $defaults['Other']['country_id'], ["class" => "form-control"]) !!}
                </div>
            </div>
        </div>
    </div>
