...
<div class="row bg-cover">
    ...
    <div class="col-lg-12 text-center">
        @if ($person->is_board_member) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'boardmembers']) }}>{{ html()->img('images/board.png', 'Board Members Group')->attribute('title', "Board Members Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_ambassador) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'ambassadors']) }}>{{ html()->img('images/ambassador.png', 'Ambassador Group')->attribute('title', "Ambassadors Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_staff) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'staff']) }}>{{ html()->img('images/employee.png', 'Staff Group')->attribute('title', "Employees Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_steward) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'stewards']) }}>{{ html()->img('images/steward.png', 'Steward Group')->attribute('title', "Stewards Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_volunteer) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'volunteers']) }}>{{ html()->img('images/volunteer.png', 'Volunteers Group')->attribute('title', "Volunteers Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_retreat_director) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'directors']) }}>{{ html()->img('images/director.png', 'Retreat Directors Group')->attribute('title', "Directors Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_retreat_innkeeper) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'innkeepers']) }}>{{ html()->img('images/innkeeper.png', 'Retreat Innkeepers Group')->attribute('title', "Innkeepers Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_retreat_assistant) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'assistants']) }}>{{ html()->img('images/assistant.png', 'Retreat Assistants Group')->attribute('title', "Assistants Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_bishop) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'bishops']) }}>{{ html()->img('images/bishop.png', 'Bishops Group')->attribute('title', "Bishop Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_pastor) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'pastors']) }}>{{ html()->img('images/pastor.png', 'Pastors Group')->attribute('title', "Pastors Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_priest) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'priests']) }}>{{ html()->img('images/priest.png', 'Priests Group')->attribute('title', "Priests Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_deacon) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'deacons']) }}>{{ html()->img('images/deacon.png', 'Deacons Group')->attribute('title', "Deacons Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_provincial) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'provincials']) }}>{{ html()->img('images/provincial.png', 'Provincials Group')->attribute('title', "Provincials Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_superior) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'superiors']) }}>{{ html()->img('images/superior.png', 'Superiors Group')->attribute('title', "Superiors Group")->class('btn btn-outline-dark') }}</a></span> @endIf
        @if ($person->is_jesuit) <span><a href={{ action([\App\Http\Controllers\PersonController::class, 'jesuits']) }}>{{ html()->img('images/jesuit.png', 'Jesuits Group')->attribute('title', "Jesuits Group")->class('btn btn-outline-dark') }}</a></span> @endIf
    </div>
    <div class="col-lg-12">
        {{ html()->form('PUT', route('person.update', [$person->id]))->acceptsFiles()->open() }}
            ...
            <div class="row text-center">
                <div class="col-lg-12 mt-2 mb-3">
                    {{ html()->image('images/save.png', 'btnSave', ['class' => 'btn btn-outline-dark']) }}
                </div>
            </div>
            <div class="row">
