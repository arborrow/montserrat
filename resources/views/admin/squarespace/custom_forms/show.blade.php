...
<div class="row bg-cover">
            ...
            <span>
                @can('create-squarespace-custom-form')
                        <a href={{ action([\App\Http\Controllers\SquarespaceCustomFormController::class, 'create_field'],$custom_form->id) }}>
                            {{ html()->img('images/create.png', 'Create Form Field')->attribute('title', "Create Form Field")->class('btn btn-light') }}
                        </a>
                @endCan
            </span>
    ...
    <div class="col-lg-12 mb-4">
        @can('update-ss-custom-form')
            <a href="{{ action([\App\Http\Controllers\SquarespaceCustomFormController::class, 'edit'], $custom_form->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
