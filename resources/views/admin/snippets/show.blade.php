    ...
    <div class="col-12 mt-3">
        <div class="row">
            <div class="col-6 text-right">
                @can('update-snippet')
                    <a href="{{ action('SnippetController@edit', $snippet->id) }}" class="btn btn-info">{!! Html::image('images/edit.png', 'Edit',array('title'=>"Edit")) !!}</a>
                @endCan
            </div>
            <div class="col-6 text-left">
                @can('delete-snippet')
                    {!! Form::open(['method' => 'DELETE', 'route' => ['snippet.destroy', $snippet->id],'onsubmit'=>'return ConfirmDelete()']) !!}
