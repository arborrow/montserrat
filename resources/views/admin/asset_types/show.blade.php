    ...
    <div class="col-lg-12 mt-3">
        <div class="row">
            <div class="col-lg-6 mt-4 mb-4">
                @can('update-asset-type')
                    <a href="{{ action([\App\Http\Controllers\AssetTypeController::class, 'edit'], $asset_type->id) }}" class="btn btn-info mr-4">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                @endCan
