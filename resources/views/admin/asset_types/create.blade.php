...
<div class="row bg-cover">
    ...
    <div class="col-lg-12">
        {{ html()->form('POST', url('admin/asset_type'))->open() }}
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4">
                        ...
                        {{ html()->select('parent_asset_type_id', $asset_types)->class('form-control') }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
            ...
            <div class="row text-center">
                <div class="col-lg-12">
                    {{ html()->submit('Add asset type')->class('btn btn-outline-dark') }}
                </div>
            </div>
        {{ html()->form()->close() }}
    </div>
