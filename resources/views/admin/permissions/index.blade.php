        ...
        <div class="jumbotron text-left">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <span class="create"><a href={{ action('PermissionController@create') }}>{!! Html::image('/images/create.png', 'Add Permission',array('title'=>"Add Permission",'class' => 'btn btn-primary')) !!}</a></span></h1>
