    ...
    <div class="col-lg-12 mt-3">
        <div class="row">
            <div class="col-lg-6 text-right">
                @can('update-donation-type')
                    <a href="{{ action([\App\Http\Controllers\DonationTypeController::class, 'edit'], $donation_type->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                @endCan
            </div>
