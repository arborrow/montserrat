                ...
                <div class='row'>
                    <div class='col-lg-6 col-md-9'>
                      <br /><strong>Mailer: </strong>  @if(null!==config('mail.default')) <div class="alert alert-success alert-important" role="alert">Configured: {{ config('mail.default') }}</div> @else <div class="alert alert-warning" role="alert">Not configured</div> @endIf
                        ...
                        <br /><strong>Encryption (MAIL_SCHEME): </strong>  @if(null!==config('mail.mailers.'. config('mail.default') . '.encryption')) <div class="alert alert-success alert-important" role="alert">Configured: {{ config('mail.mailers.'. config('mail.default') . '.encryption') }}</div> @else <div class="alert alert-warning" role="alert">Not configured</div> @endIf
