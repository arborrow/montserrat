                ...
                <div class="panel-heading">
                    <h1>
                        ...
                        @can('update-touchpoint')
                            <span class="create">
                                <a href={{ action([\App\Http\Controllers\TouchpointController::class, 'create']) }}>{{ html()->img('images/create.png', 'Add Touchpoint')->attribute('title', "Add Touchpoint")->class('btn btn-primary') }}</a>
                            </span>
                            <span class="create">
                                <a href={{ action([\App\Http\Controllers\TouchpointController::class, 'add_group'],0) }}>{{ html()->img('images/group_add.png', 'Add Group Touchpoint')->attribute('title', "Add Group Touchpoint")->class('btn btn-primary') }}</a>
                            </span>
                    </h1>@endCan
