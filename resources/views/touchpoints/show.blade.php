    ...
    <div class="jumbotron text-left">
        <div class="panel panel-default">
            ...
            <div class='row'>
                @can('update-touchpoint')
                    <div class='col-md-1'>
                        <a href="{{ action([\App\Http\Controllers\TouchpointController::class, 'edit'], $touchpoint->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                    </div>
                @endCan
