...
<section class="section-padding">
    <div class="jumbotron text-left">
        ...
        {!! Form::open(['url' => 'touchpoint/add_retreat_waitlist', 'method' => 'post', 'class' => 'form-horizontal panel']) !!}
        <span>
     ...
     <div class="col-md-1">
            <div class="form-group">
                {!! Form::submit('Add Retreat Waitlist Touchpoint', ['class'=>'btn btn-primary']) !!}
            </div>
                {!! Form::close() !!}
        </div>
    </span>
