    ...
    <div class="col-lg-12">
        <h1>
            ...
            @can('create-registration')
                <span class="options">
                    <a href={{ action([\App\Http\Controllers\RegistrationController::class, 'create']) }}>{{ html()->img('images/create.png', 'Create a Registration')->attribute('title', "Create a Registration")->class('btn btn-light') }}</a>
                </span>
            @endCan
        </h1>
