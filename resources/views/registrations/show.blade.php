...
<div class="row bg-cover">
    <div class="col-lg-12">
        <h1>
            ...
            <span class="back"><a href={{ action([\App\Http\Controllers\RegistrationController::class, 'index']) }}>{{ html()->img('images/registration.png', 'Registration Index')->attribute('title', "Registration Index")->class('btn btn-light') }}</a>
    ...
    <div class="col-lg-12">
        ...
        <div class="row mt-3">
            <div class="col-lg-6 text-right">
                @can('update-registration')
                    <a href="{{ action([\App\Http\Controllers\RegistrationController::class, 'edit'], $registration->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                @endCan
            </div>
