    ...
    <div class="col-lg-12 mt-3">
        <div class="row">
            <div class="col-lg-6 text-right">
                @can('update-asset')
                <a href="{{ action([\App\Http\Controllers\AssetJobController::class, 'edit'], $asset_job->id) }}" class="btn btn-info">{{ html()->img(asset('images/edit.png'), 'Edit')->attribute('title', "Edit") }}</a>
                @endCan
            </div>
            <div class="col-lg-6 text-left">
                @can('delete-asset')
                {{ html()->form('DELETE', route('asset_job.destroy', [$asset_job->id]))->attribute('onsubmit', 'return ConfirmDelete()')->open() }}
