        ...
        <div class="jumbotron text-left">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <span class="search"><a href={{ action([\App\Http\Controllers\SearchController::class, 'search']) }}>{!! Html::image('images/search.png', 'New search',array('title'=>"New search",'class' => 'btn btn-link')) !!}</a></span></h1>
                </div>
                @if ($persons->isEmpty())
