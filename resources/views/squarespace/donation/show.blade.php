...
<section class="section-padding">
    <div class="jumbotron text-left">
        <div class="panel panel-default">
                ...
                <div class='row'>
                    <h2>
                        @can('update-squarespace-donation')
                            <a href="{{url('squarespace/donation/'.$donation->id.'/edit')}}">SquareSpace Contribution #{{ $donation->id }} </a>
                        @else
                            SquareSpace Contribution #{{ $donation->id }}
                        @endCan
                    </h2>
                </div>
                <div class='row'>
            ...
            <div class='row'>
                <h3>Contribution from {{ ucwords(strtolower($donation->name)) }}</h3>
            </div>
            <div class='row'>
            ...
            <div class='row'>
                ...
                @if (isset($donation->event_id))
                    <div class='col-md-3'>
                        @if (isset($donation->event_id))
                            <strong>Retreat #{{ $donation->idnumber }} </strong>
