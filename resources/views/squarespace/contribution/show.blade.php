    ...
    <div class="jumbotron text-left">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <div class='row'>
                    <a href={{ action([\App\Http\Controllers\SquarespaceContributionController::class, 'index']) }}>
                        {{ html()->img('images/donation.png', 'Squarespace Contribution Index')->attribute('title', "Squarespace Contribution Index")->class('btn btn-primary') }}
                    </a>
                </div>
            </div>
            ...
            <div class='row'>
                @can('update-squarespace-contribution')
                    <div class='col-md-1'>
                        <a href="{{ action([\App\Http\Controllers\SquarespaceContributionController::class, 'edit'], $ss_contribution->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                    </div>
                @endCan
