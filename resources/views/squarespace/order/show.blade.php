    ...
    <div class="jumbotron text-left">
        <div class="panel panel-default">
            <div class="panel-heading">
                    ...
                    <span class="back"><a href={{ action([\App\Http\Controllers\SquarespaceOrderController::class, 'index']) }}>{{ html()->img('images/order.png', 'Squarespace Order Index')->attribute('title', "Squarespace Order Index")->class('btn btn-primary') }}</a></span></h1>
                </div>
                ...
                <div class='row'>
                    @can('update-squarespace-order')
                        <div class='col-md-1'>
                            <a href="{{ action([\App\Http\Controllers\SquarespaceOrderController::class, 'edit'], $order->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                        </div>
                    @endCan
