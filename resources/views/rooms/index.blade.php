            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <span class="grey">Room Index</span>
                        @can('room-create')
                            <span class="create">
                                <a href={{ action([\App\Http\Controllers\RoomController::class, 'create']) }}>{{ html()->img('images/create.png', 'Create a Room')->attribute('title', "Create Room")->class('btn btn-primary') }}</a>
                            </span>
                        @endCan
                    </h1>
