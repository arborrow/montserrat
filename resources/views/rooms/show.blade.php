    ...
    <div class="jumbotron text-left">
        <div class="panel panel-default">
            <div class="panel-heading">
                    ...
                    <span class="back"><a href={{ action([\App\Http\Controllers\RoomController::class, 'index']) }}>{{ html()->img('images/room.png', 'Room Index')->attribute('title', "Room Index")->class('btn btn-primary') }}</a></span></h1>
                </div>
                <div class='row'>
                ...
                <div class='row'>
                    @can('update-room')
                        <div class='col-md-1'>
                            <a href="{{ action([\App\Http\Controllers\RoomController::class, 'edit'], $room->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                        </div>
                    @endCan
                    @can('delete-room')
                        <div class='col-md-1'>
