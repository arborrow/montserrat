    ...
    <section class="section-padding">
        <div class="jumbotron text-left">
            <div class="panel panel-default">
                ...
                <div class='row'>
                <div class='col-md-8'>
                    <div class='panel-heading'><h2><strong>Retreat Participation for {{ $vendor->display_name }}</strong></h2></div>
                            <ul>    
            ...
            <div class='row'>
                ...
                <div class='col-md-1'>{!! Form::open(['method' => 'DELETE', 'route' => ['vendor.destroy', $vendor->id],'onsubmit'=>'return ConfirmDelete()']) !!}
