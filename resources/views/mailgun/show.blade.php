    ...
    <div class="jumbotron text-left">
        <div class="panel panel-default">
            <div class="panel-heading">
                    ...
                    <span class="back"><a href={{ action([\App\Http\Controllers\MailgunController::class, 'index']) }}>{{ html()->img('images/news29.png', 'Message Index')->attribute('title', "Message Index")->class('btn btn-primary') }}</a></span></h1>
                </div>
                <div class='row'>
                ...
                <div class='row'>
                    @can('update-message')
                        <div class='col-md-1'>
                            <a href="{{ action([\App\Http\Controllers\MailgunController::class, 'unprocess'], $message->id) }}" class="btn btn-info">{{ html()->img('images/undo.png', 'Unprocess')->attribute('title', "Unprocess") }}</a>
                        </div>
                    @endCan
                    @can('delete-message')
                        <div class='col-md-1'>
