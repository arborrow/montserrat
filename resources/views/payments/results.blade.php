        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>
                    ...
                    <span class="search"><a href={{ action([\App\Http\Controllers\PaymentController::class, 'search']) }}>{{ html()->img(asset('images/search.png'), 'New search')->attribute('title', "New search")->class('btn btn-link') }}</a></span>
                </h1>
