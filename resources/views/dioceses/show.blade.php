        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <a href={{ action([\App\Http\Controllers\DioceseController::class, 'index']) }}>
                    {{ html()->img('images/diocese.png', 'Diocese Index')->attribute('title', "Diocese Index")->class('btn btn-outline-dark') }}
                </a>
    ...
    <div class="col-lg-12 mt-3">
        ...
        <div class="row">
            <div class="col-lg-6 text-right">
                @can('update-contact')
                    <a href="{{ action([\App\Http\Controllers\DioceseController::class, 'edit'], $diocese->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                @endCan
            </div>
