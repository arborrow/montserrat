            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h1>
                        ...
                        @can('update-activity')
                            <span class="create">
                                <a href={{ action([\App\Http\Controllers\ActivityController::class, 'create']) }}>{{ html()->img('images/create.png', 'Add Activity')->attribute('title', "Add Activity")->class('btn btn-primary') }}</a>
                            </span>
                         @endCan
                    </h1>
