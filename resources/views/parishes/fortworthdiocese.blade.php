        ...
        <div class="jumbotron text-left">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <span class="create"><a href={{ action('ParishController@create') }}>{!! Html::image('/images/create.png', 'Create a Parish',array('title'=>"Create Parish",'class' => 'btn btn-default')) !!}</a></span></h1>
                </div>
                @if ($parishes->isEmpty())
