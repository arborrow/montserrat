            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h1>
                        ...
                        <span class="create"><a href={{ action('ParishController@create') }}>{!! Html::image('/images/create.png', 'Create a Parish',array('title'=>"Create Parish",'class' => 'btn btn-default')) !!}</a></span>
                    </h1>
                </div>
                @if ($parishes->isEmpty())
                    <p>No Diocese of Dallas parishes are currently in the database.</p>
                @else
                <table class="table table-bordered table-striped table-hover"><caption><h2>Diocese of Dallas Parishes</h2></caption>
                    <thead>
                        <tr>
                            <th>Name</th> 
                            <th>Diocese</th>
