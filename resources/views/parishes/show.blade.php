            ...
            <div class="col-lg-12">
                <span class="back">
                    <a href={{ action([\App\Http\Controllers\ParishController::class, 'index']) }}>
                        {{ html()->img('images/parish.png', 'Parish Index')->attribute('title', "Parish Index")->class('btn btn-outline-dark') }}
                    </a>
                </span>
                            ...
                            <tr>
                                <td><a href="../person/{{$parishioner->contact_b->id}}">
                                        @if($parishioner->contact_b->is_ambassador)
                                            {{ html()->img('images/ambassador.png', 'Ambassador')->attribute('title', "Ambassador")->class('btn btn-outline-dark') }}
                                        @endIf
