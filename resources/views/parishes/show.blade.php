    ...
    <section class="section-padding">
        <div class="jumbotron text-left">
            <div class="panel panel-default">
                ...
                <div class="row" id='parishioners'>
                    <div class="col-md-6">
                        <div class='panel-heading'>
                            <h2>
                                <span class="grey">
                                    Parishioners of {{$parish->organization_name}}
                                </span>
                            </h2> 
                        </div>
                ...
                <div class="row" id='touchpoints'>
                    <div class='col-md-8'>
                        <div class='panel-heading'>
                            <h2><strong>Touchpoints for {{ $parish->display_name }} </strong></h2>
                        </div>
                ...
                <div class='row' id='registrations'>
                    <div class='col-md-8'>
                        <div class='panel-heading'>
                            <h2><strong>Retreat Participation for {{ $parish->display_name }}</strong></h2>
                        </div>
                        <ul>    
                    ...
                    <div class='col-md-8'>
                        ...
                        @else
                            <table class="table table-striped">
                                ...
                                @foreach($parish->donations as $donation)
                                    <tr>
