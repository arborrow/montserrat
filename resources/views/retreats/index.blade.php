            ...
            <span class="options">
                @can('create-retreat')
                    <a href={{ action([\App\Http\Controllers\RetreatController::class, 'create']) }}>
                        {{ html()->img('images/create.png', 'Create a Retreat')->attribute('title', "Create Retreat")->class('btn btn-light') }}
                    </a>
                @endCan
                <a href="#previous">
                ...
                <a href={{ action([\App\Http\Controllers\RetreatController::class, 'search']) }}>
                    {{ html()->img('images/search.png', 'Search retreats')->attribute('title', "Search retreats")->class('btn btn-link') }}
                </a>
            </span>
        </h2>
