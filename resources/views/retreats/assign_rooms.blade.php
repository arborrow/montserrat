    ...
    <div class="jumbotron text-left">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <span class="back"><a href={{ action('RetreatController@index') }}>{!! Html::image('/images/retreat.png', 'Retreat Index',array('title'=>"Retreat Index",'class' => 'btn btn-default')) !!}</a></span></h1>
                <div class='row'>
        ...
        <div class="panel-heading">
            ...
            Save Room Assignments {!! Form::image('/images/save.png','btnSave',['class' => 'btn btn-default']) !!}
