...
<section class="section-padding">
    <div class="jumbotron text-left">
        {{ html()->form('POST', 'retreat/room_update')->open() }}

        <div class="panel panel-default">
            <div class="panel-heading">
                <span><h2>Retreat #<a href="{{url('retreat/'.$retreat->id)}}">{{ $retreat->idnumber }} - {{ $retreat->title }}</a></span>
                <span class="back"><a href={{ action([\App\Http\Controllers\RetreatController::class, 'index']) }}>{{ html()->img('images/retreat.png', 'Retreat Index')->attribute('title', "Retreat Index")->class('btn btn-outline-dark') }}</a></span></h1>
                <div class='row'>
        ...
        <div class="panel-heading">
            ...
            Save Room Assignments {{ html()->image('images/save.png', 'btnSave', ['class' => 'btn btn-outline-dark']) }}
