...
<section class="section-padding">
    <div class="jumbotron text-left">
        ...
        <div class='row'>
            @can('update-attachment')
                <div class='col-md-1'>
                    <a href="{{ action([\App\Http\Controllers\AttachmentController::class, 'edit'], $attachment->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                </div>
            @endCan
            <div class="clearfix"> </div>
        </div>
