	...
	<div class="container pt-0">
		<nav class="navbar navbar-expand-lg navbar-light">
          ...
          @endcan
				...
				<a href="{{action([\App\Http\Controllers\SearchController::class, 'search'])}}">{{ html()->img('images/search.png', 'Advanced search')->attribute('title', "Advanced search")->class('btn btn-link') }}</a>
				{{ html()->form()->close() }}
				@endcan
				@auth
				<div class="dropdown">
