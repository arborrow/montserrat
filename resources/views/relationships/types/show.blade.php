...
<section class="section-padding">
    <div class="jumbotron text-left">
        ...
        <div class='row'>
            ...
            <div class='row'>
                <div class='col-md-1'><a href="{{ action([\App\Http\Controllers\RelationshipTypeController::class, 'edit'], $relationship_type->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a></div>
