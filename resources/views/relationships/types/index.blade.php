        ...
        <div class="jumbotron text-left">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <span class="create"><a href={{ action([\App\Http\Controllers\RelationshipTypeController::class, 'create']) }}>{{ html()->img('images/create.png', 'Add Group')->attribute('title', "Add Group")->class('btn btn-primary') }}</a></span></h1>
