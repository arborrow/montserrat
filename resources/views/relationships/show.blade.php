...
<div class="row bg-cover">
    <div class="col-lg-12">
        <h1>
            ...
            @endCan
            <span class="back"><a href={{ action([\App\Http\Controllers\RelationshipController::class, 'index']) }}>{{ html()->img('images/relationship.png', 'relationship Index')->attribute('title', "relationship Index")->class('btn btn-light') }}</a>
        </h1>
    </div>
    <div class="col-lg-12">
        <div class="row">
        ...
        <div class="row mt-3">
            <div class="col-lg-6 text-right">
                @can('update-relationship')
                    <a href="{{ action([\App\Http\Controllers\RelationshipController::class, 'edit'], $relationship->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                @endCan
            </div>
