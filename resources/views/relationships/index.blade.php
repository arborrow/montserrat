        ...
        <div class="jumbotron text-left">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <span class="create"><a href={{ action([\App\Http\Controllers\RelationshipController::class, 'create']) }}>{{ html()->img('images/create.png', 'Add Relationship')->attribute('title', "Add Relationship")->class('btn btn-primary') }}</a></span></h1>
