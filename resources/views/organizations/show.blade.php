    ...
    <div class="col-lg-12 text-center">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-3">
                <span><a href={{ action([\App\Http\Controllers\OrganizationController::class, 'index']) }}>{{ html()->img('images/organization.png', 'Organization Index')->attribute('title', "Organization Index")->class('btn btn-outline-dark') }}</a></span>
    ...
    <div class="col-lg-12 mt-3">
        ...
        <div class="row">
            <div class="col-lg-6 text-right">
                @can('update-contact')
                    <a href="{{ action([\App\Http\Controllers\OrganizationController::class, 'edit'], $organization->id) }}" class="btn btn-info">{{ html()->img('images/edit.png', 'Edit')->attribute('title', "Edit") }}</a>
                @endCan
            </div>
