...
class AuditController extends Controller
{
    ...
    public function index()
    {
        ...
        $audits = \App\Models\Audit::with('user')->orderBy('created_at', 'DESC')->paginate(25);
    ...
    public function index_type($user_id = null)
    {
        $this->authorize('show-audit');
        $users = \App\Models\User::with('user')->orderBy('name')->pluck('name', 'id');
        $audits = \App\Models\Audit::with('user')->whereUserId($user_id)->orderBy('created_at', 'DESC')->paginate(25);
