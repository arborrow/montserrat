...
class DepartmentController extends Controller
{
    ...
    public function store(StoreDepartmentRequest $request)
    {
        ...
        return Redirect::action([\App\Http\Controllers\DepartmentController::class, 'index']);
    }
    ...
    public function update(UpdateDepartmentRequest $request, $id)
    {
        ...
        return Redirect::action([\App\Http\Controllers\DepartmentController::class, 'show'], $department->id);
    }
