...
class ExportListController extends Controller
{
    ...
    public function store(StoreExportListRequest $request)
    {
        ...
        return Redirect::action([\App\Http\Controllers\ExportListController::class, 'index']);
    }
    ...
    public function update(UpdateExportListRequest $request, $id)
    {
        ...
        return Redirect::action([\App\Http\Controllers\ExportListController::class, 'show'], $export_list->id);
    }
