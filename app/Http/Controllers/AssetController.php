...
class AssetController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $asset = \App\Asset::findOrFail($id);
        $asset_types = config('polanco.asset_types');

        return view('admin.assets.edit', compact('asset','asset_types')); //
    }
    ...
    public function update(UpdateAssetRequest $request, $id)
    {
        ...
        $asset->unit_name = $request->input('unit_name');
        $asset->unit_symbol = $request->input('unit_symbol');
        $asset->description = $request->input('description');
        $asset->is_active = $request->input('is_active');
