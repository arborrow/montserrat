...
#[Table('Donations_payment', 'payment_id')]
#[Fillable('donation_id', 'payment_id', 'payment_amount', 'payment_description', 'cknumber', 'ccnumber', 'authorization_number', 'note', 'ty_letter_sent')]
