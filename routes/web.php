...
Route::group(['middleware' => ['web', 'activity']], function () {
    ...
    Route::get('admin/config', 'PageController@config_index')->name('admin.config');
    ...
    Route::get('asset_task/{id}/schedule_jobs', 'AssetTaskController@schedule_jobs')->name('asset_tasks.schedule_jobs');
    Route::get('asset_job/create/{asset_task_id}', 'AssetJobController@create');

    Route::resource('asset', 'AssetController');
    Route::resource('asset_task', 'AssetTaskController');
    Route::resource('asset_job', 'AssetJobController');
    ...
    */
    ...
    Route::get('relationship/disjoined', 'RelationshipController@disjoined')->name('relationship.disjoined');
    Route::get('relationship/rejoin/{id}/{dominant}', 'RelationshipController@rejoin')->name('relationship.rejoin');
