...
class CreatePhoneTable extends Migration {
	...
	public function up()
	{
		Schema::create('phone', function(Blueprint $table)
		{
			...
			$table->timestamps();
			$table->enum('phone_type', array('Phone','Mobile','Fax','Pager','Voicemail','Other'))->nullable();
			$table->enum('mobile_provider', array('Sprint','Verizon','Cingular','AT&T','T-Mobile','MetroPCS','US Cellular','Other'))->nullable();
		});
	}
