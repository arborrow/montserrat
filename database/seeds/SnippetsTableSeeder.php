    ...
    public function run()
    {
        ...
        \DB::table('snippets')->insert([
            ...
            22 => [
                ...
                'locale' => 'es_ES',
                'snippet' =>
                    "Querida familia &#123;&#123;&#36;donation->contact->last_name&#125;&#125;,<br />
                    <br />
            ...
            25 => [
                ...
                'locale' => 'es_ES',
                'snippet' =>
                    "Estamos rezando por usted durante este tiempo de preparación para el retiro que se acerca.
            ...
            26 => [
                ...
                'locale' => 'es_ES',
                'snippet' =>
                    "Le esperamos de las 4:00 a las 6:00 de la tarde el &#123;&#123; &#36;participant->retreat_start_date_es &#125;&#125; para registrarse.
            ...
            27 => [
                ...
                'locale' => 'es_ES',
                'snippet' =>
                   "Favor de tomar un momento y <a href=&quot;&#123;&#123; url(&apos;intercept/&apos;.&#36;encodedUrl ) &#125;&#125;&quot;>hacer clic para confirmar que va a asistir al retiro</a>.
